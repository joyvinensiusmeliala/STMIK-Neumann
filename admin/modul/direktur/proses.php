...
if (isset($_POST['saveDirektur'])) {
    ...
    $pass= sha1($_POST['nip']);
		...
		if ($pindah) {
			$save= mysqli_query($con,"INSERT INTO tb_direktur VALUES(NULL,'$_POST[nip]','$_POST[nama]','$_POST[email]','$pass','$nama_gambar','Y','$_POST[jabatan]') ");
			if ($save) {
				echo "
  	 ...
  	 $pass= sha1($_POST['email']);
		...
		$editDirektur= mysqli_query($con,"UPDATE tb_direktur SET nama_direktur='$_POST[nama]',email='$_POST[email]',id_jabatan='$_POST[jabatan]' WHERE id_direktur='$_POST[id]' ");
