    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="post">
                  <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <input name="sks_teori" type="text" value="<?=$k['sks_teori'] ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>SKS Praktek</label>
                        <input name="sks_praktek" type="text" value="<?=$k['sks_praktek'] ?>" class="form-control">
                    </div>
                ...
                <?php 
                if (isset($_POST['edit'])) {
                    $save= mysqli_query($con,"UPDATE tb_master_mapel SET mapel='$_POST[mapel]', sks_teori='$_POST[sks_praktek]' WHERE id_mapel='$_POST[id]' ");
                    if ($save) {
                        echo "<script>
                        alert('Data diubah !');
