...
<table width="100%">
  ...
  <tr>
    ...
    <td><?=$walas['nama_dosen'] ?></td>
			...
			<div class="card-body">
				<a target="_blank" href="../dosen/modul/rekap/rekap_persemester.php?pelajaran=<?=$_GET[pelajaran] ?>&bulan=<?=$bulan;?>&kelas=<?=$_GET[kelas] ?>" class="btn btn-default">
...
<p>
	<a target="_blank" href="../dosen/modul/rekap/rekap_bulanxl.php?pelajaran=<?=$_GET[pelajaran] ?>&bulan=<?=$bulan;?>&kelas=<?=$_GET[kelas] ?>" class="btn btn-success">
<span class="btn-label">
<i class="far fa-file-excel"></i>
</span>
Export Excell
</a>
<a target="_blank" href="../dosen/modul/rekap/rekap_bulan.php?pelajaran=<?=$_GET[pelajaran] ?>&bulan=<?=$bulan;?>&kelas=<?=$_GET[kelas] ?>" class="btn btn-default">
<span class="btn-label">
<i class="fas fa-print"></i>
</span>
