            ...
            <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="wakel" class="form-control">
                            <?php 
                            $wkels = mysqli_query($con,"SELECT * FROM tb_dosen ORDER BY id_dosen ASC");
                            foreach ($wkels as $wkk) {
               ...
               <div class="form-group">
                ...
                <?php 
                if (isset($_POST['edit'])) {
                    $save= mysqli_query($con,"UPDATE tb_walikelas SET id_dosen='$_POST[wakel]',id_mkelas='$_POST[kelas]' WHERE id_walikelas='$_POST[id]' ");
                    if ($save) {
                        echo "<script>
                        alert('Data diubah !');
