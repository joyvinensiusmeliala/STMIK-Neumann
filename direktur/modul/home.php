<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Direktur STMik Kristen Neumann Indonesia</h2>
								<h5 class="text-white op-7 mb-2">Selamat Datang, <b class="text-warning"><?=$data['nama_direktur']; ?></b> | Aplikasi Absensi Siswa</h5>
							</div>
								...
								<div class="card-body">
									<div class="card-title">
										<center>
											...
											<br>
											<b>STMIK Kristen NEUMANN Indonesia</b>
										</center>
									</div>
