...
<div class="page-inner">
					...
					<div class="row">
								...
								<div class="card-body">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="form-control" name="sbs">
												<option>Pilih Mata Kuliah</option>
												<?php
												$sqlSilabus=mysqli_query($con, "SELECT * FROM tb_silabus
												...
												ORDER BY id_silabus ASC");
												while($silabus=mysqli_fetch_array($sqlSilabus)){
												echo "<option value='$silabus[id_silabus]'>$silabus[mapel]</option>";
												}
												?>
											</select>
										</div>
						...
						if (isset($_POST['save'])) {
									...
									$hitung = mysqli_num_rows(mysqli_query($con, 
									"SELECT * FROM tb_mengajar WHERE id_mkelas='$_POST[kelas]' 
									AND hari='$_POST[hari]' AND jam_mengajar='$_POST[waktu]' 
									"));
									if($hitung==0){
						...
						$insert = mysqli_query($con,"INSERT INTO tb_mengajar VALUES (NULL,'$kode','$hari','$waktu','$jamke','$dosen','$silabus','$kelas','$ta' ) ");
								...
								echo "
										...
										swal('Gagal', 'Jadwal Sudah Ada Gengs', {
										icon : 'warning',
										buttons: {        			
										confirm: {
