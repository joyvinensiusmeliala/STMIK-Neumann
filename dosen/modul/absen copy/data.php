                        ...
                        <tr>
                            ...
                            if ($k['status']==0) {
                             ...
                             <?php
                              ...
                              ?>
                              <a onclick="return confirm('Yakin NonAktifkan Semester  ??')" href="?page=master&act=set_semester&id=<?=$k['id_semester'] ?>&status=0" class="btn btn-dark btn-sm"><i class="far fa-times-circle"></i> Nonaktif</a>
                              <?php
                            }
