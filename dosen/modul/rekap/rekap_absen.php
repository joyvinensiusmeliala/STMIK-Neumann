...
<!-- hr
							<div class="card">
								...
								<!-- 	<div class="card-list">
									...
									<a href="?page=rekap&act=view&pelajaran=<?=$_GET['pelajaran'] ?>&bulan=<?=$bulan;?>&kelas=<?=$d['id_mkelas'] ?>" 
									class="btn btn-success btn-sm text-white"><i class="fa fa-eye"></i> View Absen</a>
