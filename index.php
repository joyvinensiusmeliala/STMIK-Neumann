                    ...
                    <div class="container">
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    <h2 class="text-white pb-2 fw-bold">STMIK Kristen NEUMANN Indonesia</h2>
                                    <h5 class="text-white op-7 mb-2">Aplikasi Absensi Mahasiswa Berbasis Web</h5>
                                </div>
