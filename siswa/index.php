		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.php" class="logo">
					<img src="../assets/img/logo-neumann.png" alt="navbar brand" class="navbar-brand" width="30">
					<b class="text-white">STIMK Neumann</b>
				</a>
			...
			<div class="content">
				...
				if ($page=='izin') {
					if ($act=='') {
						...
						}elseif ($act=='set_absensi') {
							include 'modul/absen/set.php';
						}
						
				}elseif ($page=='kehadiran') {
					if ($act=='') {
						include 'modul/hadir/kehadiran.php';
					}
				}elseif ($page=='rekap') {
					if ($act=='') {
						include 'modul/rekap/rekap_absen.php';
					}elseif ($act=='request') {
						include 'modul/rekap/request.php';
					}elseif ($act=='approval') {
						include 'modul/rekap/approval.php';
					}elseif ($act=='rejected') {
						include 'modul/rekap/rejected.php';
					}elseif ($act=='keseluruhan') {
						include 'modul/rekap/keseluruhan.php';
					}
				}elseif ($page=='profile') {
					if ($act=='') {
						include 'modul/profile/edit.php';
					}
				}elseif ($page=='jadwal') {
					if ($act=='') {
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi Mahasiswa STMIK Neumann (<a href="index.php">RUTH JUNI NADIA - POLITEKNIK NEGERI MEDAN </a> | 2022)
					</div>				
				</div>
			</footer>
		</div>
