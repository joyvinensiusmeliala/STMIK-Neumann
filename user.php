            ...
            <div class="wrap-login100">
                <form method="post" action="" class="login100-form validate-form">
                    <span class="login100-form-title p-b-48">
                        ...
                        <img src="./assets/img/logo-neumann.png" width="100">
                    </span>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control" name="level">
                            ...
                            <option value="3">Direktur STMiK</option>
				...
				if ($_SERVER['REQUEST_METHOD']=='POST') {
					...
					if ($level==1) {
						...
						// Direktur
								$sqlCek = mysqli_query($con,"SELECT * FROM tb_direktur WHERE nip='$_POST[username]' AND password='$pass' AND status='Y'");
								$jml = mysqli_num_rows($sqlCek);
								$d = mysqli_fetch_array($sqlCek);
								
								if ($jml > 0) {
								$_SESSION['direktur']= $d['id_direktur'];
								...
								swal('($d[nama_direktur]) ', 'Login berhasil', {
								icon : 'success',
								buttons: {        			
								confirm: {
								className : 'btn btn-success'
								...
								window.setTimeout(function(){ 
								window.location.replace('./direktur/');
								} ,3000);   
								</script>";
